...
def top5_cheapest(df): # Топ-5 самых дешевых позиций
    ...
    print(f"Топ-5 самых дешевых позиций: \n{top5}")
...
9. Топ-5 самых дешевых позиций              
10. Число товаров одной категории
11. Число товаров на одном складе
12. Фильтрация товаров по категории
13. Фильтрация товаров по складу
14. Заказать один или несколько товаров
15. Вывод товаров, цена которых больше и меньше всего на конкретном складе
16. Вывод всех товаров определённой категории
17. Фильтрация данных по цене в заданном диапазоне
18. Построить диаграмму заполненности складов.
19. Построить график числа товаров (сумма со всех складов).
20. Построить график стоимости товаров на конкретном складе.
21. Построить круговую диаграмму: доля категорий в общей стоимости всех
товаров.
22. Сохранить данные в CSV
0. Выход
""")
